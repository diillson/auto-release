...
> **NOTE**: The `diillson/auto-release` repository is an automatically generated mirror of the [diillson/actions](https://github.com/diillson/actions) monorepo containing this and other actions. Please file issues and pull requests over there.
...
You can see a working example of this workflow over at [diillson/actions](https://github.com/diillson/actions/releases/tag/latest).
...
Once again there's an example of this over at [diillson/actions](https://github.com/diillson/actions/releases/latest).
...
The main [README](https://github.com/diillson/actions/blob/master/README.md) for this project has a bunch of information related to debugging & submitting issues. If you're still stuck, try and get a hold of me on [website](https://edilsonfreitas.com/about) and I will do my best to help you out.
